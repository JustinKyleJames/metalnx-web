...
public class SC2iAuthenticationProvider implements AuthenticationProviderService, Serializable {
	...
	private static final Logger logger = LoggerFactory.getLogger(SC2iAuthenticationProvider.class);
