...
public class ResourceServiceImpl implements ResourceService {
	...
	private DataGridResource getDataGridResource(Resource irodsResource) {
		...
		try {
			...
			DataGridResource newDataGridResource = new DataGridResource(irodsResourceId, irodsResourceName,
					irodsResourceZone, irodsResourceType, irodsResourcePath, irodsResourceFreeSpace,
					irodsResourceFreeSpaceTimeStamp, irodsResourceChildren, irodsResourceParent, irodsResourceStatus,
					irodsResourceHost, irodsResourceCreateTime, irodsResourceModifyTime, irodsResourceInfo,
	...
	public List<DataGridResourceType> listResourceTypes() {
		...
		dataGridResourceTypes.add(
				new DataGridResourceType("Replication", "replication", DataGridResourceTypeEnum.IRODS_COORDINATING));
		dataGridResourceTypes.add(
				new DataGridResourceType("Round Robin", "roundrobin", DataGridResourceTypeEnum.IRODS_COORDINATING));
		dataGridResourceTypes.add(new DataGridResourceType("Load Balanced", "load_balanced",
				DataGridResourceTypeEnum.IRODS_COORDINATING));
		dataGridResourceTypes
				.add(new DataGridResourceType("Compound", "compound", DataGridResourceTypeEnum.IRODS_COORDINATING));
		dataGridResourceTypes
				.add(new DataGridResourceType("Random", "random", DataGridResourceTypeEnum.IRODS_COORDINATING));
		dataGridResourceTypes
				.add(new DataGridResourceType("Passthru", "passthru", DataGridResourceTypeEnum.IRODS_COORDINATING));

		dataGridResourceTypes.add(
				new DataGridResourceType("Unix File System", "unixfilesystem", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes.add(
				new DataGridResourceType("Universal Mass Storage", "univmss", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes.add(new DataGridResourceType("MSO", "mso", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes
				.add(new DataGridResourceType("MSSOFile", "mssofile", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes
				.add(new DataGridResourceType("Mockarchive", "mockarchive", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes
				.add(new DataGridResourceType("Non-blocking", "nonblocking", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes
				.add(new DataGridResourceType("Deferred", "deferred", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes
				.add(new DataGridResourceType("Struct file", "structfile", DataGridResourceTypeEnum.IRODS_STORAGE));
		dataGridResourceTypes
				.add(new DataGridResourceType("EMC Isilon", "isilon", DataGridResourceTypeEnum.IRODS_STORAGE));
	...
	public boolean deleteResource(String resourceName) {
		...
		try {
			...
			// if resource has a parent, it is necessary remove the relationship between
	...
	@Override
	public boolean updateResource(String resourceName, List<String> childrenToBeAdded,
			List<String> childrenToBeRemoved) {
	...
	@Override
	public List<DataGridServer> getAllResourceServers(List<DataGridResource> resources)
