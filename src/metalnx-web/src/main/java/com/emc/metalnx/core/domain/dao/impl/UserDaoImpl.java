...
public class UserDaoImpl implements UserDao {
	...
	public List<DataGridUser> findByUsername(String username) {
		...
		try {
			...
			logger.error("DataGridException when attempting to find user {}: {}", username, e);
			return userList;
		}
	...
	public DataGridUser findByUsernameAndZone(String username, String zone) {
		...
		try {
			...
			logger.error("DataGridException encounted when attempting to find by user name and zone - username=[{}] zone=[{}]: {}", username, zone, e);
			e.printStackTrace();
			return null;
		}
	}
	...
	public boolean deleteByUsername(String username) {
		...
		try {
			...
			logger.error("DataGridException when attempting to delete user {}: {}", username, e);
			return false;
		}
	...
	public List<DataGridUser> findByQueryString(String query) {
		...
		try {
			...
			logger.error("DataGridException encountered when finding users by query string {}: {}", query, e);
			e.printStackTrace();
			return userList;
		}
	}
	...
	public List<DataGridUser> findByDataGridIdList(String[] ids) {
		...
		for (String id : ids) {
			...
			try {
				...
				logger.error("DataGridException when attempting to find user by id {}: {}", id, e);
				continue;
			}
	...
	public boolean deleteByDataGridId(long id) {
		...
		try {
			...
			logger.error("DataGridException when attempting to delete user by id {}: {}", id, e);
			return false;
		}
		try {
	...
	public List<DataGridUser> findAll() {
		...
		try {
			...
			logger.error("DataGridException when attempting to find all users: {}", e);
			e.printStackTrace();
			return dataGridUserList;
		}
