...
public class FileOperationsController {
	...
	public String move(final Model model, @RequestParam("targetPath") final String targetPath,
			@RequestParam("paths[]") final String[] paths) throws DataGridException, DataGridException {
	...
	public @ResponseBody JSONObject prepareFilesForDownload(final HttpServletResponse response,
		...
		} catch (IOException | DataGridException e) {
	...
	public void download(final Model model, final HttpServletResponse response)
			throws DataGridConnectionRefusedException, DataGridException, IOException {
	...
	public ResponseEntity<String> emptyTrash() throws DataGridConnectionRefusedException, DataGridException {
